 ...
 *          examples: 
 *           getManga:
 *            $ref: '#/components/examples/getManga'
 *      400: 
 ...
 *      - bearerAuth: []
 */
router.get('/mangas/:id', desactivateRoute(false), checkAuth, checkRoleAuth(['user', 'admin']), 
routerHelper(mangaController.getObject, async (req, res, result) => {
    if(!result){
 ...
 *     - bearerAuth: []
 */
router.get('/mangas', desactivateRoute(false), checkAuth, checkRoleAuth(['user', 'admin']), 
routerHelper(mangaController.getObjects, async (req, res, result) => {
 ...
 *      examples: 
 *       postManga:
 *        $ref: '#/components/examples/postManga'
 *   responses: 
 *      201:
 ...
 *      - bearerAuth: []
 */
router.post('/mangas', desactivateRoute(false), checkAuth, checkRoleAuth(['admin']), 
routerHelper(mangaController.addObject, async (req, res, result) => {
 ...
 *      - bearerAuth: []
 */
router.put('/mangas/:id', desactivateRoute(false), checkAuth, checkRoleAuth(['admin']), 
routerHelper(mangaController.updateObject, async (req, res, result) => {
    if(!result){
 ...
 *      - bearerAuth: []
 */
router.delete('/mangas/:id', desactivateRoute(false), checkAuth, checkRoleAuth(['admin']), 
routerHelper(mangaController.deleteObject, async (req, res, result) => {
    if(!result){
